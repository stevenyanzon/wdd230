const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=5607916&units=imperial&appid=425daefc2ef0dbf9c29999e6a305ad26";
...
const forecastURL ="https://api.openweathermap.org/data/2.5/forecast?id=5607916&units=imperial&appid=425daefc2ef0dbf9c29999e6a305ad26";
...
fetch(forecastURL)
  ...
  .then((forecast) => {
    ...
    document.getElementById("day4").textContent = convertDate(daysforeCast[3].dt);
    document.getElementById("day5").textContent = convertDate(daysforeCast[4].dt);
    ...
    document.getElementById("data4").textContent = `${daysforeCast[3].main.temp}°F`;
    document.getElementById("data5").textContent = `${daysforeCast[4].main.temp}°F`;
    ...
    document.getElementById("image4").setAttribute("src", `${weatherIcon}${daysforeCast[3].weather[0].icon}.png`);
    document.getElementById("image5").setAttribute("src", `${weatherIcon}${daysforeCast[4].weather[0].icon}.png`);
